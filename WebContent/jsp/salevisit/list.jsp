...
<BODY>
	<s:form id="customerForm" name="customerForm" action="saleVisit_findAll" method="post" theme="simple">
											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														<%-- <s:textfield name="visit_time" id="visit_time" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50" ></s:textfield> --%>
													</TD>
													<TD>到</TD>
													<TD>
