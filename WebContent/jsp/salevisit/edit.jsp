...
<script type="text/javascript">
	$(function(){
		...
		$.post("${pageContext.request.contextPath }/user_findAllCustomer.action", {},function(data){
			//遍历json
			$(data).each(function(i, n){
...
<BODY>
	<s:form id="form1" name="form1" namespace="/" action="saleVisit_update" method="post" theme="simple">
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：客户拜访记录 &gt; 添加客户拜访记录</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访地点 ：</td>
								<td>
									<s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" maxLength="50" name="visit_addr"/>
								</td>
							</TR>
							...
							<TR>
								...
								<td>拜访详情 ：</td>
								<td>
								<s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" maxLength="50" name="visit_detail"/>
								</td>
								<td>下次拜访时间 ：</td>
								<td>
